...
import { actions } from "./Objects/Dashboard";
...
function Promotion() {
  return (
    <Dashboard>
      ...
      <div className="m-10 overflow-hidden bg-gray-200 divide-y divide-gray-200 rounded-lg shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
