...
function AdminNotification() {
    return (
        <Profile>
            <section className="admin-noti1" id="notification">
                <div className="admin-noti2">
                    <h2 className="admin-noti3">TODAY</h2>
                    <div className="admin-noti4">
                        <div className="admin-noti5">
                            <svg
                                width={16}
                                height={16}
                                viewBox="0 0 16 16"
                        ...
                        <div className="pl-3">
                            <p className="comm1">
                                <span className="color-noti-indigo">
                                    James Doe
                                </span>{" "}
                                favourited an{" "}
                                <span className="color-noti-indigo">item</span>
                            </p>
                            <p className="admin-noti6">2 hours ago</p>
                        </div>
                    </div>
                    <div className="admin-noti7">
                        <div className="admin-noti8">
                            <svg
                                width={16}
                                height={16}
                                viewBox="0 0 16 16"
                    ...
                    <div className="admin-noti10">
                        ...
                        <div className="pl-3">
                            <p className="comm1">
                                <span className="color-noti-indigo">Sarah</span>{" "}
                    ...
                    <h2 className="admin-noti3">YESTERDAY</h2>
                    <div className="admin-noti11">
                        <div className="admin-noti5">
                            <svg
                                width={16}
                                height={16}
                    ...
                    <div className="admin-noti12">
                        <div className="admin-noti13">
                            <svg
                                width={16}
                                height={16}
                                viewBox="0 0 16 16"
                        ...
                        <div className="w-full pl-3">
                            <div className="admin-noti14">
                                <p className="admin-noti15">
                                    Someone Delivered Too good today
                                </p>
                                <p className="admin-noti16">View</p>
                            </div>
                        </div>
                    </div>
                    <div className="admin-noti17">
                        <hr className="w-full" />
                        <p className="admin-noti18">Thats it for now :)</p>
                        <hr className="w-full" />
                    </div>
                </div>
            </section>
